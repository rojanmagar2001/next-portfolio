  ...
  return (
    <div className="h-full bg-primary/60">
      <div className="h-screen  bg-gradient-to-r from-black/30 via-black/50 to-black/60 py-32 text-center xl:text-left flex items-center justify-center">
        <div className="container text-center flex flex-col items-center justify-center xl:border-[1px] md:p-16 border-accent">
          ...
          <div className="flex justify-between mt-10 gap-x-5">
            <div className="flex flex-col items-center justify-center xl:bg-white h-[475px] w-[495px] text-center rounded-lg p-5">
              <p className="text-white/40 xl:text-black p text-lg xl:text-sm">
